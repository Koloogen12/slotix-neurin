/** Small inline icon set matching the design reference's stroke style
 * (`stroke=currentColor`, `stroke-width:2`, round caps/joins). Kept together so the
 * booking flow's info panel and calendar controls share one source. */
...
export function RubleIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArrowLeftIcon({ className, size = 17 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CheckCircleIcon({ className, size = 38 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AlertIcon({ className, size = 17 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
